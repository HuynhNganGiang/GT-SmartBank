...
(function() {
    ...
    const responses = {
        ...
        "chi nhanh": "Bạn có thể tra cứu toàn bộ mạng lưới chi nhánh và cây ATM trên bản đồ số trực quan bằng cách nhấp chọn danh mục **Chi nhánh & ATM** ở thanh điều hướng bên trái, hoặc truy cập trực tiếp liên kết công khai: [Chi nhánh & ATM](/pages/chi-nhanh-atm.html).\n\nHệ thống sẽ hiển thị danh sách, thông tin liên lạc, giờ làm việc chi tiết và liên kết Chỉ đường đi qua Google Maps cho từng địa điểm.",
    ...
    function getAiResponse(userText) {
        ...
        if (text.includes("khoa the") || text.includes("khoa") || text.includes("mat the") || text.includes("lock")) {
            return responses["khoa the"];
        }
        if (text.includes("hello") || text.includes("hi") || text.includes("xin chao") || text.includes("chao")) {
            return "Xin chào! Tôi là trợ lý ảo GT SmartBank. Tôi có thể giúp gì cho bạn hôm nay? Hãy chọn một trong các gợi ý bên dưới hoặc nhập câu hỏi của bạn nhé.";
        }
